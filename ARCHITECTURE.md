...
- `WeeklyHistoryTable.qml`: Extracted modular 7-day network traffic history container implementing calibrated column widths (`colDayWidth: 74`, `colDateWidth: 44`, `colDownWidth: 54`, `colUpWidth: 54`, `colTotalWidth: 80`) and right-elision with anchor-based alignment across both header and delegates, ensuring full weekday names (e.g. Wednesday, Thursday) never overlap date labels across any system font scaling down to 620px.
